-- This is for testing schema mismatch (s is replaced with z for every table)

-- Drop tables if they exist
DROP TABLE IF EXISTS Orderz;
DROP TABLE IF EXISTS Productz;
DROP TABLE IF EXISTS Customerz;
...
INSERT INTO Customerz (customer_id, customer_name, email, join_date) VALUES
...
-- Insert Product data
INSERT INTO Productz (product_id, product_name, price) VALUES
    (101, 'Laptop', 1200.00),
    (102, 'Smartphone', 800.00),
    (103, 'Headphones', 150.00);

-- Insert Order data
INSERT INTO Orderz (order_id, customer_id, product_id, order_date, quantity) VALUES
